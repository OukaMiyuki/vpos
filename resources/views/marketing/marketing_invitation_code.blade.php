                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="selection-datatable" class="table dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        @php $no=0; @endphp
                                        @foreach($invitationCodeList as $code)
                                            <tr>
                                                <td>{{ $no+=1 }}</td>
                                                <td>
                                                    {{ $code->code }}
                                                </td>
                                                <td>{{ $code->holder_name }}</td>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="px-3" action="{{ route('marketing.dashboard.invitation_code.store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="code" class="form-label">Kode</label>
                            <input class="form-control" type="text" id="code" name="code" required="" placeholder="Masukkan kode undangan">
                            <small id="emailHelp" class="form-text text-muted">Kode maksimal 5 karakter, terdiri dari huruf & angka | Contoh : xAkl1</small>
                        </div>
                        <div class="mb-3">
