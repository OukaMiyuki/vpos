    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                ...
                <img src="{{ !empty(auth()->user()->photo) ? Storage::url('images/profile/'.auth()->user()->photo) : asset('assets/images/blank_profile.png') }}" alt="user-image" class="rounded-circle">
                <span class="pro-user-name ms-1">
                    {{ auth()->user()->detailUser->nama_lengkap }} <i class="mdi mdi-chevron-down"></i> 
                </span>
                </a>
            ...
            <li class="dropdown d-none d-xl-block">
                ...
                <div class="dropdown-menu">
                    ...
                    @elseif(auth()->user()->type == "marketing")
                        ...
                        <a href="javascript:void(0);" class="dropdown-item">
                            <i class="mdi mdi-qrcode-plus me-1"></i>
                            <span>Tambah Invitation Code</span>
                        </a>
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <i class="fe-bar-chart-line- me-1"></i>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <ul class="list-unstyled megamenu-list">
                                            ...
                                            <li>
                                                <a href="javascript:void(0);">Site Profile Settings</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Contact Settings</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col-md-4">
                                        <h5 class="text-dark mt-0">Administrator</h5>
                                        <ul class="list-unstyled megamenu-list">
                                            <li>
